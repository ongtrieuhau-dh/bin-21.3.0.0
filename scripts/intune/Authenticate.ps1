...
Import-Module -Name "$PSScriptRoot\\..\\..\\third-party\\msal.ps"

function Get-AuthToken 
{
    $clientId = "18f38b91-c10f-44d7-8c3d-cbb0be704f77"
    $scopes = @("DeviceManagementApps.ReadWrite.All")
    try 
    {
        $MsalToken = Get-MsalToken -ClientId $clientId -Scope $scopes
        if (-not [string]::IsNullOrEmpty($MsalToken)) 
        {
            $authHeader = @{
        ...
        {
            throw "An error occurred getting the access token"
        }
    }
    catch 
    {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDWI2fu2JiQdhtj
# PSUrzD4y4qyxaT08DUt7nZM/Z/DRNKCCInQwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# hvcNAQkEMSIEIIiLmfmlf2aRHHx4pVq/07vG/rLIHKnrfboBRxjQCd6lMDgGCisG
# AQQBgjcCAQwxKjAooCaAJABBAGQAdgBhAG4AYwBlAGQAIABJAG4AcwB0AGEAbABs
# AGUAcjANBgkqhkiG9w0BAQEFAASCAYBAjoZpkJ2bwWFH8l8SZmjugJZlbNfClVDY
# IAIQhJGim6VfknIuUyOdVS30jJllYra3vURXNE8sdL+0YKPJqHJo6zPTrMELfdk5
# TodrqswI+1J7ZATT2qxVgOnFRGN2uRbUV1fBip1sxZWnrrqr5HjdwdSYEQksRm/h
# WzIJY7jAZl3dgiTwxYyceWVoUwkv4RZsThJ7iTVbVRamK18nd5F1G0tcq0lPZGQo
# N9sKEQvXMoEDRq3hIATbT6hFpgDwtFJ2JgA9ub5Bk+iTWHbzbuiIKfukmUp0NAsP
# kbOxqsvPh9sYdxIBVqe70dFNCxzfyI7AxO3Et6iWRybUqEUs5wLawdcPcTpSomhr
# 6zQf+OO+TCa1zyFBR/S3GZSPoU5Vav+kBmczP5HiLwj8gRu6KGnzf86E9ojko7/l
# 8Em8X2k8NIxagemkyzXc1bhF0s2PRmKI+WKqIp1EfSEw9aBMaydn0CgzqyMnS0tz
# LjU0JGTTGJNDBpLRWR9kJEzfSRiAYgGhghSgMIIUnAYKKwYBBAGCNwMDATGCFIww
...
# ZQMEAgEFAAQgmU5zT7c2iR+y0WTU2rpmBGcAbs74FpEwOOwji9vZ+gMCBmVl+dI+
# MRgTMjAyMzEyMTQxMjUyNDAuOTk2WjAEgAIB9KCB4KSB3TCB2jELMAkGA1UEBhMC
...
# DQEJBDEiBCBeL7IMPnWnBGFcvSerkgI3t197+FP4QWQR9M/9pRuvbjCB3QYLKoZI
...
# ZqS9RGYAldXDaqMpF2fDI5NxW8sMc12mMA0GCSqGSIb3DQEBCwUABIICAJ7w6uXt
# bpveRZWmsmBcxaLUOx+cOCknSKvkFzddfWww4bCCF5BxFnny7TCi73r9LUkwHONU
# 0T/WvLyz5/FbxZ6SgonF9nFuM17o9vQFNa3vr30N99ZrKmwVsMpMgksdaODU1JE/
# b/3QOG1jOZkzov/NCdTZ6Wy6VqCBoOL2l1t7hmTQN9HS93FxkSEs/CWca5t/sXua
# NtWJqqe/wTmKhX57RYJthbESKA9j6HhNRQS9NwrbXB5/OUuf3labhEMPC/9M6Ddv
# ZGROOvrDp2JwS4SKwfPWCnm0uY3qHMOIl/6BnfH0Cjbv3MEI6xo9H6QqTpIqlB4m
# PoG05vlGWx4pL3+frXB4YrAlFP30JwV51OG8Qdnz42n//RZNXZMULmJiB+wIi4pg
# PeaPefJxYCZzt96+eokuvJGzgFyY6zLCUW3Oph9J9q6oUSbtAhwW7Q5Cpp9tXOu5
# eFUAF59ncAD/gqlNu7KGGULV8sIv5zvDMfgcBieg2ETUSv/tedhlCmKd4aWgWMqe
# JECNyjJv9kN2uq82ZkkoFB0FCqNHQ9fhtwV6iZm4trstQZM7974RJlSZd1LQ8X+Z
# 6fa98+0t3gyiTnWhy9F8GNByb7s4DuwxRvXj+R3JR547+lWxIpcGEm+VXimvMUmS
# +O51CLA6mYhA2F1kvZUlJ+91AyT6p/jJ2T8K
